            ...
            <SelectContent>
              ...
              <SelectItem value="approved">
                <div className="flex items-center gap-2">
                  ...
                  <Badge variant="secondary" className="text-xs">{filterCounts.approved}</Badge>
                </div>
              </SelectItem>
              <SelectItem value="active">
                <div className="flex items-center gap-2">
                  <span>Active Scenes</span>
                  <Badge variant="secondary" className="text-xs">{filterCounts.active}</Badge>
                </div>
              </SelectItem>
              <SelectItem value="pending">
                <div className="flex items-center gap-2">
                  <span>Pending Review</span>
                  <Badge variant="secondary" className="text-xs">{filterCounts.pending}</Badge>
                </div>
              </SelectItem>
              <SelectItem value="rejected">
                <div className="flex items-center gap-2">
                  <span>Rejected Only</span>
                  <Badge variant="secondary" className="text-xs">{filterCounts.rejected}</Badge>
                </div>
              </SelectItem>
              <SelectItem value="with-metadata">
                <div className="flex items-center gap-2">
                  <span>With Metadata</span>
                  <Badge variant="secondary" className="text-xs">{filterCounts.withMetadata}</Badge>
                </div>
              </SelectItem>
              <SelectItem value="without-metadata">
                <div className="flex items-center gap-2">
                  <span>Without Metadata</span>
                  <Badge variant="secondary" className="text-xs">{filterCounts.withoutMetadata}</Badge>
                </div>
              </SelectItem>
            </SelectContent>
          </Select>
